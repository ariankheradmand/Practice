    ...
    <nav className="flex items-center justify-center w-full">
      ...
      >
        ...
        <div className="flex gap-2">
          {/* Login Button */}
          <div className="relative p-1 rounded-lg bg-gradient-to-r from-purple-500 via-orange-400 to-purple-500 bg-[length:200%_200%] animate-gradient">
            <div className="bg-white/80 py-px px-2 rounded relative z-10">
